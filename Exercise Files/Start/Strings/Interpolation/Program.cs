...
namespace StringInterpolation
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("It is a {0} {1} {2} with {3} miles and costs ${4}",
                    year,make,model,miles,price);


            // TODO: Using string interpolation
            Console.WriteLine($"It is a {year} {make} {model} with {miles} miles and costs ${price}");


            // TODO: With inline expressions
            Console.WriteLine($"It is a {year} {make} {model} with {miles * 1.6:F2} km and costs {price:C2}");
